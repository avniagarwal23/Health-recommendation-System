...
![](https://github.com/anuj-glitch/Disease-Preiction-using-Django-and-machine-learning/blob/master/screenshots/Capture3.PNG)
...
### ***Go to the [Readme.pdf](Readme.pdf) file for information on project & screenshots.***
